...
const char AP_NameChar[] = "LEDControl";      // Set Name for WiFi // YOU MUST CHANGE THE NAME
const char WiFiPassword[] = "12345678";       // Set Password for WiFi (Leave "" For Open WiFi)
